...
MEMORY_GUIDANCE = (
    ...
    "Save broad reusable environment facts or project-level constraints to target='memory'. "
    ...
    "Do NOT save one-off task state, prompt-like instructions, "
...
_MEMORY_REVIEW_PROMPT = (
    ...
    "Be conservative with memory changes (target='memory'): save only broad environment/project "
    "constraints or durable collaboration context that will affect behavior across many future tasks.\n"
    ...
    "workflow notes better represented as skills, or anything "
...
_COMBINED_REVIEW_PROMPT = (
    ...
    "# Memory updates\n"
    "Be conservative with memory updates (target='memory'): save only broad "
    "environment/project constraints or durable collaboration context that will "
    "affect behavior across many future tasks.\n"
