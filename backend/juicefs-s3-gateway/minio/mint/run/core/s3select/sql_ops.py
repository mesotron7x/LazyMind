...
def test_sql_expressions_custom_input_output(client, input_bytes, sql_input,
    ...
    try:
        ...
        for idx, (_test_name, select_expression, expected_output) in enumerate(tests):
...
"""
    ...
    tests = [
        ...
        # DATE_DIFF
        ('DATE_DIFF_1',
         "select DATE_DIFF(year, TO_TIMESTAMP(s.datez), TO_TIMESTAMP('2011-01-01T')) from S3Object as s",
         b'-6\n'),
        ('DATE_DIFF_2',
         "select DATE_DIFF(month, TO_TIMESTAMP(s.datez), TO_TIMESTAMP('2011T')) from S3Object as s",
         b'-72\n'),
        ('DATE_DIFF_3',
         "select DATE_DIFF(day, TO_TIMESTAMP(s.datez), TO_TIMESTAMP('2010-01-02T')) from S3Object as s",
         b'-2556\n'),
        # EXTRACT
        ...
        ('TO_STRING_1', "select TO_STRING(TO_TIMESTAMP(s.datez), 'MMMM d, y') from S3Object as s",
            b'"January 2, 2017"\n'),
        ('TO_STRING_2',
         "select TO_STRING(TO_TIMESTAMP(s.datez), 'MMM d, yyyy') from S3Object as s",
         b'"Jan 2, 2017"\n'),
        ...
        ('TO_STRING_5',
            "select TO_STRING(TO_TIMESTAMP(s.datez), 'MMMM d, y h:m a') from S3Object as s",
            b'"January 2, 2017 3:4 AM"\n'),
        ('TO_STRING_6',
            "select TO_STRING(TO_TIMESTAMP(s.datez), 'y-MM-dd''T''H:m:ssX') from S3Object as s",
            b'2017-01-02T3:4:05+0730\n'),
        ('TO_STRING_7',
            "select TO_STRING(TO_TIMESTAMP(s.datez), 'y-MM-dd''T''H:m:ssX') from S3Object as s",
            b'2017-01-02T3:4:05+0730\n'),
        ('TO_STRING_8',
            "select TO_STRING(TO_TIMESTAMP(s.datez), 'y-MM-dd''T''H:m:ssXXXX') from S3Object as s",
            b'2017-01-02T3:4:05+0730\n'),
        ('TO_STRING_9',
            "select TO_STRING(TO_TIMESTAMP(s.datez), 'y-MM-dd''T''H:m:ssXXXXX') from S3Object as s",
