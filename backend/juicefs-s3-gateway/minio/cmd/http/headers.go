...
const (
	...
	// file server专用, 走sensetime公有云鉴权
	SensetimeSaaSUserID = "x-user-id"
	// file server专用, 走sensetime公有云鉴权
	SensetimeSaaSTenantID = "x-tenant-id"
	// file server专用, 走sensetime公有云鉴权
	SensetimeSaaSTraceID = "x-trace-id"
	// file server专用, 走sensetime datalake 自有鉴权
	SensetimeOneAPIUserID = "oneapi-user-id"
	// file server专用, 走sensetime datalake 自有鉴权
	SensetimeOneAPIUserName = "oneapi-user-name"
)
