...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_role_permissions_permission_group_id'), 'role_permissions', ['permission_group_id'], unique=False)
    ...
    op.create_index(op.f('ix_group_permissions_permission_group_id'), 'group_permissions', ['permission_group_id'], unique=False)
